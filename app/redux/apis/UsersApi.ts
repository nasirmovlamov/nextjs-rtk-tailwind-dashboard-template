...
import { IUser } from '../interfaces/general/user';

/* this example api is boilerplate to increase speed of api creation */
// change api name to your api name
type IExample = IUser; // import your interface and assign to this type
const apiName = 'users';
...
export const usersApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    createItem: builder.mutation<GenericResponse<IExample>, Omit<IExample, 'id' | 'roles'>>({
      query: (data) => ({
        url: `${apiName}`,
        method: 'POST',
        data: data,
